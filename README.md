...
Первая ссылка в предпоследнем разделе, см. аннотацию
...
docs содержит документы с девяти различных стадий, по ним вы можете видеть как менялся проект.

meta содержит всякий мусор, краденые статьи и прочие штуки полезные для работы но бесполезные для вас.

benchmarks содержит внутренние бенчмарки по которым я определял состояние работы.

code и code_naive содержат код наивной и оптимизированной реализаций.
